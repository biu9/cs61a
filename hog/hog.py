...
def swine_align(player_score, opponent_score):
    ...
    if (player_score == 0 or opponent_score == 0):
        ...
        i = 0
        for k in range(min(player_score,opponent_score),1,-1):
...
def pig_pass(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4b
    "*** YOUR CODE HERE ***"
    num = player_score-opponent_score
    if num<=-3 or num>=0:
        return False
    else:
        return True
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
            while who == 0:
                num0_roll = strategy0(score0,score1)
                score0 = score0 + take_turn(num0_roll,score1,dice)
                ...
                if flag == True:
                    ...
                    who = other(who)
            while who == 1:
                num1_roll = strategy1(score1,score0)
                score1 = score1 + take_turn(num1_roll,score0,dice)
